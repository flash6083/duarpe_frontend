...
export default async function Page(props: pageProps) {
  ...
  // If the category listing is an async server function that may return a NextResponse
  // (for example to redirect), call it here and handle that case before rendering.
  const categoryListing = await CategoryListingPage({});
  if (categoryListing instanceof NextResponse) {
